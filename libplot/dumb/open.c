...
/*
 * This accepts plot file formats and produces the appropriate plots for dumb
 * terminals.  It can also be used for printing terminals and lineprinter
 * listings, although there is no way to specify number of lines and columns
 * different from your terminal.  This would be easy to change, and is left
